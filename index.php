    ...
    <div class="service_container">
      <div class="container ">
        <div class="heading_container heading_center">
          <h2>
            Naše<span> investiční služby</span>
          </h2>
          <p>
      ...
      <div class="team_container">
        <div class="row">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="box ">
              <div class="img-box">
                <img src="images/cervenka.jpg" class="img1" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Jan Červenka
  ...
  <section class="client_section layout_padding">
    <div class="container">
      <div class="heading_container heading_center psudo_white_primary mb_45">
        <h2>
          Co o nás říkají <span>zákazníci</span>
        </h2>
      </div>
      <div class="carousel-wrap ">
        <div class="owl-carousel client_owl-carousel">
          <div class="item">
            <div class="box">
              <div class="img-box">
                <img src="images/volny.jpg" alt="" class="box-img">
              </div>
              <div class="detail-box">
                <div class="client_id">
          ...
          <div class="item">
            <div class="box">
              <div class="img-box">
                <img src="images/okamura.jpg" alt="" class="box-img">
              </div>
              <div class="detail-box">
                <div class="client_id">
                  <div class="client_info">
